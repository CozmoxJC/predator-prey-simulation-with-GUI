...
public class SimulatorRFBH
{
     ...
     */
    public static void SimulatorRFBH()
    {
        SimulatorRFBH(100,100);
    }
     ...
     */
    public static void SimulatorRFBH(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    public static void simulateOneStep()
    {
        ...
        // Add the newly born hunters, bear, foxes and rabbits to the main lists.
    ...
    /**
     * Randomly populate the field with hunters, bears, foxes and rabbits.
     */
