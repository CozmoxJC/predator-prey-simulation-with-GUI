...
public class SimulatorWB
{
     ...
     */
    public static void SimulatorWB()
    {
        SimulatorWB(100,100);
    }
     ...
     */
    public static void SimulatorWB(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    public static void simulateOneStep()
    {
        ...
        // Add the newly born bears and wolves to the main lists.
