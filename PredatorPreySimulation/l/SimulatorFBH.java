...
public class SimulatorFBH
{
     ...
     */
    public static void SimulatorFBH()
    {
        SimulatorFBH(100,100);
    }
     ...
     */
    public static void SimulatorFBH(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    /**
     * Randomly populate the field with hunters, bears and foxes.
     */
