 ...
 * containing  wolves, foxes and rabbits.
 * 
 * @author Jeremy Chu
 * @version 2021.05.30
 */
public class SimulatorRFW
{
     ...
     */
    public static void SimulatorRFW()
    {
        SimulatorRFW(100,100);
    }
     ...
     */
    public static void SimulatorRFW(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
