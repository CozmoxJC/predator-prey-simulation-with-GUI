...
public class SimulatorRFWB
{
     ...
     */
    public static void SimulatorRFWB()
    {
        SimulatorRFWB(100,100);
    }
     ...
     */
    public static void SimulatorRFWB(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    public static void simulateOneStep()
    {
        ...
        // Add the newly born bears, wolves, foxes and rabbits to the main lists.
    ...
    /**
     * Randomly populate the field with bears, wolves, foxes and rabbits.
     */
