...
public class SimulatorRFWH
{
     ...
     */
    public static void SimulatorRFWH()
    {
        SimulatorRFWH(100,100);
    }
     ...
     */
    public static void SimulatorRFWH(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    public static void simulateOneStep()
    {
        ...
        // Add the newly born hunters, wolves, foxes and rabbits to the main lists.
