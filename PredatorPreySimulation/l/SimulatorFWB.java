...
public class SimulatorFWB
{
     ...
     */
    public static void SimulatorFWB()
    {
        SimulatorFWB(100,100);
    }
     ...
     */
    public static void SimulatorFWB(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    /**
     * Randomly populate the field with bears wolves and foxes.
     */
