 ...
 * containing  bears and rabbits.
 * 
 * @author Jeremy Chu
 * @version 2021.05.30
 */
public class SimulatorRB
{
     ...
     */
    public static void SimulatorRB()
    {
        SimulatorRB(100,100);
    }
     ...
     */
    public static void SimulatorRB(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    public static void simulateOneStep()
    {
        ...
        // Add the newly born bears and rabbits to the main lists.
    ...
    /**
     * Randomly populate the field with bears and rabbits.
     */
