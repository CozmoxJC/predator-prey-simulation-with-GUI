...
public class SimulatorRBH
{
     ...
     */
    public static void SimulatorRBH()
    {
        SimulatorRBH(100,100);
    }
     ...
     */
    public static void SimulatorRBH(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    public static void simulateOneStep()
    {
        ...
        // Add the newly born hunters, bears and rabbits to the main lists.
    ...
    /**
     * Randomly populate the field with hunters, bears and rabbits.
     */
