...
public class SimulatorFB
{
     ...
     */
    public static void SimulatorFB()
    {
        SimulatorFB(100,100);
    }
     ...
     */
    public static void SimulatorFB(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    public static void simulateOneStep()
    {
        ...
        // Add the newly born bears and foxes to the main lists.
    ...
    /**
     * Randomly populate the field with bears and foxes.
     */
