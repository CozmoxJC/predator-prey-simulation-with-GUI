...
public class SimulatorWBH
{
     ...
     */
    public static void SimulatorWBH()
    {
        SimulatorWBH(100,100);
    }
     ...
     */
    public static void SimulatorWBH(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    public static void simulateOneStep()
    {
        ...
        // Add the newly born hunters, bears and wolves to the main lists.
    ...
    /**
     * Randomly populate the field with hunters, bears and wolves.
     */
