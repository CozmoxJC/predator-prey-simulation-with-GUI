...
public class SimulatorBH
{
     ...
     */
    public static void SimulatorBH()
    {
        SimulatorBH(100,100);
    }
     ...
     */
    public static void SimulatorBH(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    public static void simulateOneStep()
    {
        ...
        // Add the newly born hunters and bears to the main lists.
