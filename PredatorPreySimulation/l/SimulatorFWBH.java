...
public class SimulatorFWBH
{
     ...
     */
    public static void SimulatorFWBH()
    {
        SimulatorFWBH(100,100);
    }
     ...
     */
    public static void SimulatorFWBH(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    public static void simulateOneStep()
    {
        ...
        // Add the newly born hunters, bears, wolves and foxes to the main lists.
    ...
    /**
     * Randomly populate the field with hunters, bears wolves and foxes.
     */
