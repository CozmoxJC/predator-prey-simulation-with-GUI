...
public class SimulatorRFH
{
     ...
     */
    public static void SimulatorRFH()
    {
        SimulatorRFH(100,100);
    }
     ...
     */
    public static void SimulatorRFH(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    /**
     * Randomly populate the field with hunters, foxes and rabbits.
     */
