...
public class SimulatorRWBH
{
     ...
     */
    public static void SimulatorRWBH()
    {
        SimulatorRWBH(100,100);
    }
     ...
     */
    public static void SimulatorRWBH(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    public static void simulateOneStep()
    {
        ...
        // Add the newly born hunter, bear, wolves and rabbits to the main lists.
    ...
    /**
     * Randomly populate the field with hunter, bear, wolves and rabbits.
     */
