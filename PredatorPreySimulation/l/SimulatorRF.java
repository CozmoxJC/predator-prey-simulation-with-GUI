...
public class SimulatorRF
{
     ...
     */
    public static void SimulatorRF()
    {
        SimulatorRF(100, 100);
    }
     ...
     */
    public static void SimulatorRF(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    /**
     * Randomly populate the field withfoxes and rabbits.
     */
