...
public class SimulatorRWH
{
     ...
     */
    public static void SimulatorRWH()
    {
        SimulatorRWH(100,100);
    }
     ...
     */
    public static void SimulatorRWH(int depth, int width)
    {
        if(width <= 0 || depth <= 0) {
    ...
    public static void simulateOneStep()
    {
        ...
        // Add the newly born hunters, wolves and rabbits to the main lists.
